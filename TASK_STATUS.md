...
55. **✅ Done** — **Order again / repeat** (EN+EL):
   ...
   - **Staff:** each order card's "Add item" section has **"+ {item}" quick chips** for every line already in the order — one click adds one more of exactly that item (same price/modifiers/note) and recalculates the total. E2E-covered
